...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 bg-light-surface dark:bg-dark-surface">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">
            ...
            <br />
            <span className="gradient-text dark:dark-gradient-text">Something Together</span>
          </h2>
