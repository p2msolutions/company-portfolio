                    ...
                    <>
                      <SEOHead 
                        ...
                        breadcrumbs={[
                          ...
                          { name: "Projects", url: "https://p2msolutions.com/projects" }
                        ]}
                      />
                      <Project />
                    </>
                    ...
                    <>
                      <SEOHead 
                        ...
                        breadcrumbs={[
                          { name: "Home", url: "https://p2msolutions.com" },
                          { name: "Projects", url: "https://p2msolutions.com/projects" },
                          { name: "Project Details", url: "https://p2msolutions.com/projects/details" }
                        ]}
                      />
                      <ProjectDetails />
                    </>
                  ...
                  element={
                    <>
                      <SEOHead 
                        ...
                        breadcrumbs={[
                          { name: "Home", url: "https://p2msolutions.com" },
                          { name: "About", url: "https://p2msolutions.com/about" }
                        ]}
                      />
                      <About />
                    </>
                  ...
                  element={
                    <>
                      <SEOHead 
                        ...
                        breadcrumbs={[
                          { name: "Home", url: "https://p2msolutions.com" },
                          { name: "Pricing", url: "https://p2msolutions.com/pricing" }
                        ]}
                      />
                      <Pricing />
                    </>
                   ...
                   element={
                     <>
                       <SEOHead 
                         ...
                         breadcrumbs={[
                           { name: "Home", url: "https://p2msolutions.com" },
                           { name: "Services", url: "https://p2msolutions.com/service" }
                         ]}
                       />
                       <Service />
                     </>
                   ...
                   element={
                     <>
                       <SEOHead 
                         ...
                         breadcrumbs={[
                           { name: "Home", url: "https://p2msolutions.com" },
                           { name: "Contact", url: "https://p2msolutions.com/contact" }
                         ]}
                       />
                       <Contact />
                     </>
